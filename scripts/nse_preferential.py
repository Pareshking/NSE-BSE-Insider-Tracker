"""NSE-only Preferential Issue acquisition/probe. Transport and schema remain NSE-specific."""
...
def main() -> None:
    ...
    report = {"source": "NSE", "dataset": "preferential_issue", "target_date": str(TARGET), "homepage_status": home.status_code, "windows": []}
