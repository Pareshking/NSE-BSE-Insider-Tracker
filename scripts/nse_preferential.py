"""NSE Preferential Issue extraction/validation.

Uses the official NSE PREF page with a real browser because the page is JS-rendered.
...
URL = f"{BASE}/companies-listing/corporate-filings-PREF"
OUT = Path("artifacts/nse_validation/preferential")
...
def main() -> None:
    ...
    driver = browser()
    report = {"source": "NSE", "dataset": "preferential_issue", "url": URL, "target_date": str(TARGET), "windows": []}
    try:
